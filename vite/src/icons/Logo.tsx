...
const Logo: FC<LogoProps> = ({ isLinkHover }) => {
  return (
    <svg
      id="Layer_1"
      data-name="Layer 1"
      ...
      viewBox="0 0 923 923"
      className={`pb-1 w-12 h-12 md:w-16 md:h-16 flex justify-center items-center rounded-full mr-2 ${
        isLinkHover ? "text-black bg-slimeGreen-200" : "text-green-700"
      }`}
    >
      <defs>
